...
export class MainEndpoint extends LitElement {
  ...
  @property({ type: Array }) menuTabs: MenuTab[] = [
    {route: 'master-detail-view-java', name: 'master-detail-view-java'},
    {route: 'master-detail-view-designer', name: 'master-detail-view-designer'},
    {route: 'master-detail-view-typescript', name: 'master-detail-view-typescript'},
  ];
